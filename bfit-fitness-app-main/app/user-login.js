...
const UserLoginScreen = () => {
  ...
  // --- 2. WRAP THE ENTIRE SCREEN IN KEYBOARDAVOIDINGVIEW AND SCROLLVIEW ---
  return (
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.inputContainer}>
            ...
            />
            <FontAwesome5 name="user-alt" size={20} color="#F37307" style={styles.icon} />
          </View>
...
const styles = StyleSheet.create({
  // --- 3. ADJUSTED CONTAINER STYLE FOR SCROLLVIEW ---
  container: {
      // It no longer needs flex: 1
